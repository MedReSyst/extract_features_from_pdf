# -*- coding: utf-8 -*-
"""
Created on Fri Jan 26 15:04:57 2024
        ...
        for i in range(len(request_list)):
            ...
            for box, score, label in zip(boxes, scores, labels):
                ...
                if text[label] == texts[0][0]:
                    rect = patches.Rectangle((x_b_left, y_b_left), width,
                                             height, linewidth=2,
...
if __name__ == '__main__':
    ...
    img = 'C:/Users/path/bilan/Exemple_protocoles_bilan_neuropsy.pdf'
    texts = [['a drawing of a clock', 'a drawing of a circle']]

    output_path = 'C:/Users/path/bilan/out/'

    pdf_to_jpg(img, texts, output_path)
